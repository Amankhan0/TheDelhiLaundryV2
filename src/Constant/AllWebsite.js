...
export const MainLogo = 'https://framerusercontent.com/images/mBVjqOKkzoCZ5jl6HOGwLIYqG0o.png?scale-down-to=512'
export const MainVideo = 'https://framerusercontent.com/assets/xD7lv7zCMkZyHtcGT5G9eMEHAQ.mp4'
export const HomePageText1 = 'Modern Machines, Faster Wash'
...
// Home sixth page 
export const HomePageText31 = 'Our Testimonials'
...
export const StaffData = [
    {
        description: 'Fast & Reliable! Picked up at noon, delivered the same day fresh and neatly folded. Excellent service, super easy, highly recommended!',
        name: 'Rahul Maurya',
        designation: 'Fitness Manager at VAULT By Virat Kohli',
        star: 5,
        image:'https://icons.veryicon.com/png/o/miscellaneous/user-avatar/user-avatar-male-5.png'
    },
    {
        description: 'The Delhi Laundry is super quick and reliable! Got my clothes fresh, clean, and neatly folded the same day. Highly recommended!',
        name: 'Pooja',
        designation: 'Consultants at Gaudium IVF Centre ',
        star: 5,
...
export const HomePageText38 = 'About Us'
export const HomePageText39 = 'About'
export const HomePageText40 = 'Laundry Hub'
...
export const BlogsData = [
    ...
    },
    {
        ...
        image: 'https://thumbs.dreamstime.com/b/portrait-normal-man-smiling-over-grey-background-young-face-high-detailed-30820412.jpg'
    },
    {
        category: "Blog 3",
        title: 'What is Lorem Ipsum?',
        description: "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.",
        image: 'https://cdn.photoworkout.com/wp-content/uploads/2022/07/man-photoshoot-idea.jpeg'
    },
    {
        category: "Blog 4",
        title: 'What is Lorem Ipsum?',
        description: "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.",
        image: 'https://media.istockphoto.com/id/1181083533/photo/portrait-of-men-looking-at-camera.jpg?s=612x612&w=0&k=20&c=KUM9F0_KgSvBLK_nM_OxjU1OTw1Q2b3pHBSMtJ9Jj4E='
    },
]


export const specialOfferTitle = 'SPECIAL OFFER –'
export const specialOfferPara = 'Fresh Laundry, Big Savings!'
export const specialOfferDescription = 'Get FREE Ironing on your First Order with The Delhi Laundry 🧺. Experience professional cleaning, fast turnaround, and fresh clothes delivered to your doorstep.'

export const specialOfferWhy = 'Why Choose The Delhi Laundry?'

export const offerLatterPointsArr = [
    {
        title: 'Fast & Efficient – ',
        description: 'Quick service with modern machines, no compromise on quality.'
    },
    {
        title: 'Eco-Friendly Cleaning – ',
        description: 'Gentle on fabrics, safe for your clothes and the planet.'
    },
    {
        title: 'Expert Care – ',
        description: 'Fresh, clean, and neatly folded clothes every time.'
    }
]
...
export const FAQDesTitle = 'FREQUENTLY ASKED QUESTIONS'
export const FAQDes = 'At The Delhi Laundry, we care about customer satisfaction. Thousands across Delhi trust us for fresh, clean laundry daily. Find answers to the most common questions below.'
